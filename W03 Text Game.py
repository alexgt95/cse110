...
def horrow_game():
    ...
    slow_type(
        "After a long day in the beach sun, you and your friends decide to relax and go to the movies."
    )
    slow_type(
        "The movie was really funny, you are just having a good time and laughing."
    )
    slow_type("You just blink and the lights go out, and you hear a loud crash.")
    slow_type(
        "Then you turn around and find yourself alone in an old abandoned movie theater."
    )
    slow_type("You start watching moments of your childhood on the screen.")
    slow_type(
        "Be careful to type the right words, or it will be the end of you...your game I mean...yeah..."
    )

    choice1 = (
        input("Do you want to watch the MOVIE or go EXPLORE the theater? >> ")
        .strip()
        .lower()
    )
    ...
    if choice1 == "movie":
        ...
        slow_type(
            "Do you try to STAY to figure out what's going on, or escape to EXPLORE the empty hallways?"
        )
        ...
        if choice2 == "stay":
            ...
            if choice3 == "door":
                ...
                slow_type(
                    "You see a big red button that says 'EJECT.' Do you press it?"
                )
                ...
                if choice4 == "eject":
                    ...
                    slow_type(
                        "You find yourself back in the theater with your friends."
                    )
                    slow_type(
                        "You breathe a sigh of relief. You are confused, but you are out!"
                    )
                else:
                    slow_type(
                    ...
                    slow_type(
                        "You feel yourself being pulled in. You scream, but no one hears you."
                    )
                ...
                slow_type("Invalid choice. You are trapped in the movie forever. Game over.")
            ...
            if choice3 == "talk":
                ...
                slow_type(
                    "You are trapped in that moment of your life forever. Game over."
                )
            elif choice3 == "run":
                slow_type(
                ...
                if choice4 == "enter":
                    ...
                    slow_type(
                        "He welcomes you and says: 'You are the first one to find me!'"
                    )
                    slow_type(
                        "Finally! It is now my turn to go back to the real world."
                    )
                    ...
                    if choice5 == "hear":
                        ...
                        slow_type(
                            "You will live forever as long as you are in the theater."
                        )
                        slow_type(
                            "But if you tell anyone, you will be trapped forever."
                        )
                        choice6 = (
                            input(
                                "He starts to walk away, do you FOLLOW him or STAY? >> "
                            )
                            .strip()
                            .lower()
                        )
                        ...
                        if choice6 == "join":
                            ...
                            slow_type(
                                "You shave freed all people previousl trapped in the theater!"
                            )
                            slow_type("You are a true hero!")
                        elif choice6 == "fight":
                            slow_type("\nYou yell: 'I will never join you!'")
                            slow_type(
                                "He laughs and says: 'You are wrong but I would have done the same.'"
                            )
                            slow_type("You fight him and win.")
                            slow_type(
                                "Someone enters the room and tells you: 'Congrats! You are my new teather manager!'"
                            )
                            slow_type(
                                "You are in control of the place but you will never leave."
                            )
                            slow_type(
                                "You can see your friends and family on the screen but they can't see you."
                            )
                            slow_type("You scream, but no one hears you.")
            ...
            slow_type("A child version of you suddenly holds your hand")
            slow_type("Come in with me")
            slow_type("You are now this age forever like me")
            slow_type("Game over")
    elif choice1 == "explore":
        slow_type("\nYou find your friends in the lobby.")
        slow_type(
            "They are all staring at the screen, but you are not sure what they are watching."
        )
        ...
        if choice2 == "talk":
            ...
            slow_type(
                "They freak out and start blaming you for getting them all trapped."
            )
            ...
            slow_type("...this is the only place where that is valid!")
            slow_type("CONGRATULATIONS!", 0.5)
            slow_type("You open your eyes and find yourself back in the theater.")
            slow_type("You fell asleep and it was all a dream.")
            slow_type(
                "You are free to go back with your friends and enjoy your spring break!"
            )
    else:
        slow_type("Invalid option...way to ruin the fun!")
